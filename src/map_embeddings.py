...
def main():
    ...
    final_src_list = [src_ind2word[wi] for wi in src_indices]
    final_tar_list = [trg_ind2word[wi] for wi in trg_indices]
    final_trans_pairs = zip(final_src_list, final_tar_list)
    pickle.dump(final_trans_pairs, open(args.trg_output + ".ArtSLFinalPairs.pickle","wb")) 
